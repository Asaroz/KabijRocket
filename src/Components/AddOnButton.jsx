...
=======
      <div className="buttons">
        ...
        <button className="addOnBtn" onClick={() => Click({type: 'WATER_INCREMENT'},state.water)} className="water btn"><h2 className="addOnName">WATER</h2>{state.water.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'VEGETATION_INCREMENT'},state.veg)} className="veg btn"><h2 className="addOnName">VEGETATION</h2>{state.veg.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'HOUSING_INCREMENT'},state.house)} className="housing btn"><h2 className="addOnName">HOUSING</h2>{state.house.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'DINOS_INCREMENT'},state.dinos)} className="dinos btn"><img className="addOnicon" src={dinoButton}/><h2>DINOS</h2>{state.dinos.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'ENERGY_INCREMENT'},state.energy)} className="energy btn"><h2 className="addOnName">ENERGY</h2>{state.energy.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'FACTORY_INCREMENT'},state.factory)} className="factory btn"><h2 className="addOnName">FACTORY</h2>{state.factory.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'FARMING_INCREMENT'},state.farming)} className="farm btn"><img className="addOnicon" src={farmingButton}/><h2 className="addOnName">FARMING</h2>{state.farming.amount}</button>
        <button className="addOnBtn" onClick={() => Click({type: 'MINING_INCREMENT'},state.mining)} className="mine btn"><h2>MINING</h2>{state.mining.amount}</button>
>>>>>>> Stashed changes
